...
![Access lab devices via web browser](images/prepare-lab/access-via-web-browser/1-1.png)
...
![Lab remote access VPN details](images/prepare-lab/access-using-vpn/1-2.png)

![Lab remote access VPN details](images/prepare-lab/access-using-vpn/1-3.png)
